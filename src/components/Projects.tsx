...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'Một ứng dụng quản lý nhân viên với giao diện người dùng trực quan và đồng bộ hóa đám mây.',
      tags: ['Python', 'Odoo', 'PostgreSQL', 'Docker'],
      image: 'public/images/project_2.png',
      github: 'https://github.com/ChucNguyen2k2/datn_odoo',
      demo: '#',
    },
    {
      ...
      github: 'https://github.com/ChucNguyen2k2/azure-white-bio-main',
      demo: '#',
    },
  ];
